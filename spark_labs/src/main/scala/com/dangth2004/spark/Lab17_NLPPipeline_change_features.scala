...
object Lab17_NLPPipeline_change_features {
  def main(args: Array[String]): Unit = {
    ...
    */
    ...
    val log_path = "../log/lab17_metrics_change_features.log" // Corrected path
    ...
    val result_path = "../results/lab17_pipeline_output_change_features.txt" // Corrected path
