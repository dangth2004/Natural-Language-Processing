...
object Lab17_NLPPipeline_normal_tokenizer {
  def main(args: Array[String]): Unit = {
    ...
    val log_path = "../log/lab17_metrics_normal_tokenizer.log" // Corrected path
    ...
    val result_path = "../results/lab17_pipeline_output_normal_tokenizer.txt" // Corrected path
