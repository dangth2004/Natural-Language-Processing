# Báo cáo công việc đã hoàn thành của Lab 3

## Mô tả công việc đã triển khai

Trong Lab 3, các kỹ thuật về word embedding đã được triển khai bằng Python và PySpark để biểu diễn từ và văn bản dưới
